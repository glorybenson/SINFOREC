(function ($) {
    ...
    (function () {
        ...
        $( '#formControl').on( 'click', openNav);

        $(function() {
            var $sections = $('.form-section');
            // Get all buttons with class="navs" inside the container
            var navs = document.getElementsByClassName("wizard-navs");
            ...
            $('.form-navigation .next').click(function() {
                $('.demo-form').parsley().whenValidate({
                    ...
                    console.log(wizardCurrentIcon, $(wizardCurrentIcon).length)
                    // if (!$(wizardCurrentIcon)) {
                    //     $(wizardCurrent).append(' <i id="' + wizardCurrentIcon + '-fa" class="fa fa-check-circle-o fa-3x"></i>');
                    // }
        ...
        function openNav() {
            var x = document.getElementById('wizard-ul');
            console.log(x.style.display)
            if (x.style.display === 'none') {
                x.style.display = 'block'
                document.getElementById("open-menu").classList.remove("fa-chevron-right");
                document.getElementById("open-menu").classList.add("fa-chevron-down");
            } else {
                x.style.display = 'none'
                document.getElementById("open-menu").classList.remove("fa-chevron-down");
                document.getElementById("open-menu").classList.add("fa-chevron-right");
            }
        }

        function viewOpenNav() {
            var x = document.getElementById('wizard-ul');
