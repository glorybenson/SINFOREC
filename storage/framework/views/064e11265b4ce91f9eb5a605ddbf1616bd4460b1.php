<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <!-- <?php if(in_array(1, Auth::user()->roles) || in_array(2, Auth::user()->roles)): ?>
                <li class="<?php echo e(request()->is('home') || request()->is('edit-user/*') || request()->is('create-user')? 'active active-now': ''); ?>">
                    <a href="<?php echo e(route('home')); ?>"><i class="feather-home"></i>
                        <span class="shape1"></span><span class="shape2"></span>
                        <span>Users</span></a>
                </li>
<?php endif; ?>

            <?php if(in_array(1, Auth::user()->roles) || in_array(3, Auth::user()->roles)): ?>
                <li class="">
...
<?php endif; ?>
                ...
                <?php if( $roles->has_admin): ?>
                    <li class="">
                        <a href="#"><i class="feather-users"></i>
                            <span class="shape1"></span><span class="shape2"></span>
                            <span>Administration</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="<?php echo e(route('home')); ?>">Utilisateurs </a></li>
                            <li><a href="<?php echo e(route('pays.index')); ?>">Pays</a></li>
                            <li><a href="<?php echo e(route('regions.index')); ?>">Régions</a></li>
                            <li><a href="<?php echo e(route('department.index')); ?>">Départements</a></li>
                            <li><a href="<?php echo e(route('arrondissement')); ?>">Arrondissements </a></li>
                            <li><a href="<?php echo e(route('communes')); ?>">Communes </a></li>
                            <li><a href="<?php echo e(route('centre')); ?>">Centres</a></li>
                        </ul>
                    </li>
                <?php endif; ?>

                <?php if( $roles->has_naissance): ?>
                    <li class="">
                        <a href="#"><i class="feather-gift"></i>
                            <span class="shape1"></span><span class="shape2"></span>
                            <span>Naissance</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                        <li><a href="<?php echo e(route('naissance.registre')); ?>">Registre</a></li>
...
<?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/layouts/includes/sidebar.blade.php ENDPATH**/ ?>