                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="breadcrumb ml-2">
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('arrondissement')); ?>">Arrondissement</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST"
                                        action="<?php echo e(route('arrondissement.edit.post', ['id' => $arrondissement->id])); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input value="<?php echo e($arrondissement->description); ?>" class="form-control" id="description" name="description"
                                                    required>
                                                ...
                                                <select data-live-search="true" name="department_id" class="selectpicker w-100"
                                                    ...
                                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            <?php echo e($item->id ===  $arrondissement->department_id ? 'selected' : ''); ?> >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/arrondissement/edit.blade.php ENDPATH**/ ?>