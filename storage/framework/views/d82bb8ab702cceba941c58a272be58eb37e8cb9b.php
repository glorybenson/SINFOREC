                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(route('edit.user.post', ['id' => $user->id])); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input value="<?php echo e($user->first_name); ?>" id="first_name" type="text"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input id="last_name" type="text" class="form-control " name="last_name"
                                                       value="<?php echo e($user->last_name); ?>" required autocomplete="name" autofocus>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <select multiple class="select" name="role[]" required
                                                    ...
                                                    <?php $__currentLoopData = \App\Models\Role::$roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($role); ?>" <?php echo e($mapping[ $role]); ?>><?php echo e($value); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/users/edit.blade.php ENDPATH**/ ?>