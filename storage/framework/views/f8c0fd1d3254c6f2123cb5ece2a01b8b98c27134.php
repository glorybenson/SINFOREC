                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="breadcrumb ml-2">
                                        <li class="breadcrumb-item text-capitalize"><a
                                                href="<?php echo e(route('centre')); ?>">centre</a>
                                        </li>
                    ...
                    <div class="row" data-conn="<?php echo e($link); ?>">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(route('centre.create.post')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            <label for="description"
                                                   class="col-md-2 col-form-label text-md-end">Description</label>
                                            <div class="col-md-10">
                                                <input value="<?php echo e(old('description')); ?>" class="form-control" name="description" required>
                                                ...
                                                <div class="col-md-10">
                                                    <select data-live-search="true" data-name="regions" name="regions"
                                                        ...
                                                        <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(((object)$item)->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/centre/create.blade.php ENDPATH**/ ?>