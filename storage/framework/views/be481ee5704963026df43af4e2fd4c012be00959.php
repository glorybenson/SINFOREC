                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(route('region.create.post')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            <label for="description"
                                                class="col-md-2 col-form-label text-md-end">Description</label>
                                            <div class="col-md-10">
                                                <input class="form-control" id="description" name="description" type="text" value="<?php echo e(old('description')); ?>"
                                                    required>
                                            ...
                                            <div class="col-md-10">
                                                <select class="selectpicker w-100" data-live-search="true" name="pay_id"
                                                    ...
                                                    <?php for( $i = 0; $i < count( $countries); ++$i): ?>
                                                        <option value="<?php echo e($countries[ $i]->id); ?>"><?php echo e($countries[ $i]->description); ?></option>
                                                    <?php endfor; ?>
                                                </select>
                                                <?php if( $errors->any()): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/regions/create.blade.php ENDPATH**/ ?>