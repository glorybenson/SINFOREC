                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="breadcrumb ml-2">
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('department.index')); ?>">Department</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST"
                                        action="<?php echo e(route('department.edit.post', ['id' => $department->id])); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <input value="<?php echo e($department->description); ?>" type="text" class="form-control" id="description" name="description"
                                                    required>
                                            ...
                                            <div class="col-md-10">
                                                <select data-live-search="true" name="region" class="selectpicker w-100"
                                                    ...
                                                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>" <?php echo e($item->id === $department->region_id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hephhay/Documents/web/Birth/resources/views/department/edit.blade.php ENDPATH**/ ?>