                ...
                <div class="col-md-12">
                    <div class="d-flex align-items-center">
                        ...
                        <ul class="breadcrumb ml-2">
                            <li class="breadcrumb-item active"><a href="{{ route('naissance.registre.create') }}" class="text-primary">Registre des Naissances</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                @if (isset($regions))
                                                    <select id="judgment-region" data-live-search="true" name="judgment-region" class="selectpicker w-100 serializable removable" tabindex="4" data-parsley-errors-container="#invalid-feedback46" required >
                                                        @if (count($regions) == 1)
                                                            <option value="{{ ((object)$regions[0])->description }}">{{ ((object)$regions[0])->description }}</option>
                                                        @else
                                                            <option value="" selected>--</option>
